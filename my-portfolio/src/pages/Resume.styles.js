...
export const DownloadButton = styled.a`
  ...
  background: ${({ theme }) =>
    theme.body === "#FFF" ? "rgba(0,0,0,0.05)" : "rgba(255,255,255,0.1)"};
  border: 1.5px solid
    ${({ theme }) =>
      theme.body === "#FFF" ? "rgba(0,0,0,0.1)" : "rgba(255,255,255,0.25)"};
  border-radius: 50px;
  ...
  &::before {
    ...
    border-radius: 50%;
    background: ${({ theme }) =>
      theme.body === "#FFF" ? "rgba(0,0,0,0.1)" : "rgba(255,255,255,0.2)"};
  ...
  &:hover {
    border-color: ${({ theme }) =>
      theme.body === "#FFF" ? "rgba(0,0,0,0.2)" : "rgba(255,255,255,0.5)"};
